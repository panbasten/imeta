...
public class JobEntryFTPDelete extends JobEntryBase implements Cloneable, JobEntryInterface
{
	...
	public String getXML()
	{
	  ...
	  public void setInfo(Map<String, String[]> p, String id,
		  ...
		  protocol = JobEntryBase.parameterToString(p.get(id + ".protocol"));
		  ...
		  proxyPassword = JobEntryBase.parameterToString(p.get(id + ".proxyPassword"));
		  keyFilename = JobEntryBase.parameterToString(p.get(id + ".keyFilename"));
		  keyFilePass = JobEntryBase.parameterToString(p.get(id + ".nr_limit_success"));
		  nr_limit_success = JobEntryBase.parameterToString(p.get(id + ".nr_limit_success"));
		  ...
		  copyprevious = JobEntryBase.parameterToBoolean(p.get(id + ".copyprevious"));	
		  useproxy = JobEntryBase.parameterToBoolean(p.get(id + ".useproxy"));	
