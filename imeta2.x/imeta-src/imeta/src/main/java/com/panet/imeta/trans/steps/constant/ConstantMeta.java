...
public class ConstantMeta extends BaseStepMeta implements StepMetaInterface {
	...
	public void setInfo(Map<String, String[]> p, String id,
		...
		String[] currency = p.get(id + "_fields.currency");
		String[] decimal = p.get(id + "_fields.decimal");
		String[] group = p.get(id + "_fields.group");
		...
		this.currency = (currency != null) ? currency : (new String[0]);
		this.decimal = (decimal != null) ? decimal : (new String[0]);
		this.group = (group != null) ? group : (new String[0]);
