...
@Step(name="WebServiceLookup",image="WSL.png",tooltip="BaseStep.TypeTooltipDesc.WebServiceLookup",description="BaseStep.TypeLongDesc.WebServiceLookup",
		category=StepCategory.CATEGORY_LOOKUP)
public class WebServiceMeta extends BaseStepMeta implements StepMetaInterface
{
	public static final String STEP_ATTRIBUTE_WSURL = "wsUrl";
	public static final String STEP_ATTRIBUTE_WSOPERATION = "wsOperation";
	public static final String STEP_ATTRIBUTE_PASSINGINPUTDATA = "passingInputData";
	public static final String STEP_ATTRIBUTE_COMPATIBLE = "compatible";
	public static final String STEP_ATTRIBUTE_REPEATING_ELEMENT = "repeating_element";
	public static final String STEP_ATTRIBUTE_REPLY_AS_STRING = "reply_as_string";
	public static final String STEP_ATTRIBUTE_HTTPLOGIN = "httpLogin";
	public static final String STEP_ATTRIBUTE_HTTPPASSWORD = "httpPassword";
	public static final String STEP_ATTRIBUTE_PROXYHOST = "proxyHost";
	public static final String STEP_ATTRIBUTE_PROXYPORT = "proxyPort";
    ...
    public void setInfo(Map<String, String[]> p, String id,
    	...
    	operationName = BaseStepMeta.parameterToString(p.get(id + ".operationName"));
    	passingInputData = BaseStepMeta.parameterToBoolean(p.get(id + ".passingInputData"));
    	compatible = BaseStepMeta.parameterToBoolean(p.get(id + ".compatible"));
    	repeatingElementName = BaseStepMeta.parameterToString(p.get(id + ".repeatingElementName"));
    	returningReplyAsString = BaseStepMeta.parameterToBoolean(p.get(id + ".returningReplyAsString"));
    	httpLogin = BaseStepMeta.parameterToString(p.get(id + ".httpLogin"));
    	httpPassword = BaseStepMeta.parameterToString(p.get(id + ".httpPassword"));
    	proxyHost = BaseStepMeta.parameterToString(p.get(id + ".proxyHost"));
    	proxyPort = BaseStepMeta.parameterToString(p.get(id + ".proxyPort"));
