...
{
	public static final String STEP_ATTRIBUTE_UPDATE = "update";
	...
	public static final String STEP_ATTRIBUTE_RETURN_NAME = "return_name";
	public static final String STEP_ATTRIBUTE_RETURN_RENAME = "return_rename";
	public static final String STEP_ATTRIBUTE_SEQUENCE = "sequence";
	public static final String STEP_ATTRIBUTE_USE_AUTOINC = "use_autoinc";
	public static final String STEP_ATTRIBUTE_VERSION_FIELD = "version_field";
	public static final String STEP_ATTRIBUTE_DATE_NAME = "date_name";
	public static final String STEP_ATTRIBUTE_DATE_FROM = "date_from";
	public static final String STEP_ATTRIBUTE_MIN_YEAR = "min_year";
	public static final String STEP_ATTRIBUTE_DATE_TO = "date_to";
	public static final String STEP_ATTRIBUTE_MAX_YEAR = "max_year";
...
//    cacheSize = (int) rep.getStepAttributeInteger(id_step, "cache_size"); //$NON-NLS-1$
	...
	public void setInfo(Map<String, String[]> p, String id,
		...
		update = BaseStepMeta.parameterToBoolean(p.get(id + ".update"));
		dateField = BaseStepMeta.parameterToString(p.get(id + ".dateField"));
		dateFrom = BaseStepMeta.parameterToString(p.get(id + ".dateFrom"));
		dateTo = BaseStepMeta.parameterToString(p.get(id + ".dateTo"));
		keyField = BaseStepMeta.parameterToString(p.get(id + ".keyField"));
		keyRename = BaseStepMeta.parameterToString(p.get(id + ".keyRename"));		
		autoIncrement = BaseStepMeta.parameterToBoolean(p.get(id + ".autoIncrement"));
		versionField = BaseStepMeta.parameterToString(p.get(id + ".versionField"));
		techKeyCreation = BaseStepMeta.parameterToString(p.get(id + ".techKeyCreation"));
		sequenceName = BaseStepMeta.parameterToString(p.get(id + ".sequenceName"));
		minYear = BaseStepMeta.parameterToInt(p.get(id + ".minYear"));
		maxYear = BaseStepMeta.parameterToInt(p.get(id + ".maxYear"));
		cacheSize = BaseStepMeta.parameterToInt(p.get(id + ".cacheSize"));
		
		String[] keyStream = p.get(id + "_keys.keyStream");
		String[] keyLookup = p.get(id + "_keys.keyLookup");
		String[] fieldStream = p.get(id + "_fields.fieldStream");
		String[] fieldLookup = p.get(id + "_fields.fieldLookup");
		String[] fieldUpdate = p.get(id + "_fields.fieldUpdate");

		this.keyStream = keyStream;
		this.keyLookup = keyLookup;
		this.fieldStream = fieldStream;
		this.fieldLookup = fieldLookup;
		this.fieldUpdate = stringArrayToIntArray(fieldUpdate, 0);
	}
