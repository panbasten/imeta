...
*/
package com.panet.imeta.core.config;

import java.util.Collection;
import java.util.LinkedHashSet;

import com.panet.imeta.core.Const;
import com.panet.imeta.core.annotations.Inject;
...
import com.panet.imeta.trans.step.Messages;
...
public class AnnotatedStepsConfigManager<T extends StepPluginMeta> extends BasicConfigManager<T> 
{
	...
	public Collection<T> load() throws KettleConfigException
	{
		...
		for (Class<?> clazz : resolver.getClasses())
		{
			...
			if (Const.isEmpty(packageName)) packageName = com.panet.imeta.trans.step.Messages.class.getPackage().getName();
