...
*/
package com.panet.imeta.core.reflection;
...
{
	private static final String LOCAL_PACKAGE = "com.panet.imeta";
    ...
    public static final void findMetaData(Object object, int level, List<StringSearchResult> stringList, Object parentObject, Object grandParentObject)
    {
        ...
        for (int i=0;i<fields.length;i++)
        {
            ...
            // A sanctioned package is either the local package (com.panet.imeta) or
