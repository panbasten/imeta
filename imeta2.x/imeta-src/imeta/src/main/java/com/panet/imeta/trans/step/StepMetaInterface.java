...
public interface StepMetaInterface {
	 ...
	 * 
	 * @param inputRowMeta
	 *            The fields that are entering the step. These are changed to
	 *            reflect the output metadata.
	 * @param name
	 *            The name of the step to be used as origin
	 * @param info
	 ...
	 *            with it: ignore it or not. Interesting is also that in case of
	 *            database lookups, the layout of the target database table is
	 *            put in info[0]
	 * @param nextStep
	 ...
	 * @see com.panet.imeta.core.CheckResult
	 * @param stepMeta
	...
	/**
	 * @return The fields used by this step, this is being used for the Impact
	 *         analyses.
	 */
	...
	/**
	 * Standard method to return an SQLStatement object with SQL statements that
	 * the step needs in order to work correctly. This can mean "create table",
