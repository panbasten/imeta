...
public class StringCutMeta extends BaseStepMeta implements StepMetaInterface {
	...
	public void setInfo(Map<String, String[]> p, String id,
		...
		String[] cutFrom = p.get(id + "_fields.cutFrom");
		String[] cutTo = p.get(id + "_fields.cutTo");
		...
		this.cutFrom = (cutFrom != null) ? cutFrom : (new String[0]);
		this.cutTo = (cutTo != null) ? cutTo : (new String[0]);
	}
