...
/*
 *    UnivariateStatsMetaFunction.java
...
/**
 * Holds meta information about one univariate stats calculation:
 * source field name and what derived values are to be computed
 *
...
public class UnivariateStatsMetaFunction implements Cloneable {
   ...
   *
   * @param sourceFieldName the name of the input field to
   * compute stats for
   * @param n output N
   ...
   * @param median compute and output the median (requires data 
   * caching and sorting)
   * @param arbPercentile compute and output a percentile
   * (0 <= arbPercentile <= 1)
   * @param interpolate true if interpolation is to be used for 
  ...
  public UnivariateStatsMetaFunction(Node uniNode) {
    String temp;
    m_sourceFieldName = 
      XMLHandler.getTagValue(uniNode, "source_field_name");
  ...
  /**
   * Return a String containing XML describing this
  ...
  public void saveRep(Repository rep, long id_transformation, 
    ...
    rep.saveStepAttribute(id_transformation, id_step, nr, "source_field_name",
                          m_sourceFieldName);
    rep.saveStepAttribute(id_transformation, id_step, nr, "N",
                          m_n);
    rep.saveStepAttribute(id_transformation, id_step, nr, "mean",
                          m_mean);
    rep.saveStepAttribute(id_transformation, id_step, nr, "stdDev",
                          m_stdDev);
    rep.saveStepAttribute(id_transformation, id_step, nr, "min",
                          m_min);
    rep.saveStepAttribute(id_transformation, id_step, nr, "max",
                          m_max);
    rep.saveStepAttribute(id_transformation, id_step, nr, "median",
                          m_median);
    rep.saveStepAttribute(id_transformation, id_step, nr, "percentile",
                          " "+m_arbitraryPercentile);
    rep.saveStepAttribute(id_transformation, id_step, nr, "interpolate",
                          m_interpolatePercentile);
  }
  ...
  public Object clone() {
    try {
      UnivariateStatsMetaFunction retval = 
        (UnivariateStatsMetaFunction) super.clone();
  ...
  /**
   * Set the name of the input field used by this
   * UnivariateStatsMetaFunction.
   *
  ...
  /**
   * Return the name of the input field used by this
   * UnivariateStatsMetaFunction
   *
  ...
  /**
   * Get whether N is to be calculated for this input
   * field
   *
  ...
  /**
   * Set whether to calculate the mean for this input
   * field
   *
  ...
  /**
   * Get whether the mean is to be calculated for this
   * input field
   *
  ...
  /**
   * Set whether the standard deviation is to be
   * calculated for this input value
   *
   * @param b true if the standard deviation is to
   * be calculated
   */
  ...
  /**
   * Get whether the standard deviation is to be
   * calculated for this input value
   *
   * @return true if the standard deviation is to
   * be calculated
   */
  ...
  /**
   * Set whether the minimum is to be calculated for
   * this input value
   *
  ...
  /**
   * Get whether the minimum is to be calculated for
   * this input value
   *
  ...
  /**
   * Set whether the maximum is to be calculated for
   * this input value
   *
  ...
  /**
   * Get whether the maximum is to be calculated for
   * this input value
   *
  ...
  /**
   * Set whether the median is to be calculated for
   * this input value
   *
  ...
  /**
   * Get whether the median is to be calculated for
   * this input value
   *
  ...
  /**
   * Get whether interpolation is to be used in
  ...
  /**
   * Set whether interpolation is to be used in
   * the computation of percentiles
   *
  ...
  /**
   * Gets whether an arbitrary percentile is
   * to be calculated for this input field
   *
  ...
  /**
   * Sets whether an arbitrary percentile is
   * to be calculated for this input field
   *
