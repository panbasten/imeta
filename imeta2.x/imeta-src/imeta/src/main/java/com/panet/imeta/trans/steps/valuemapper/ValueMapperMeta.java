 ...
 */
@Step(name="ValueMapper",image="VMP.png",tooltip="BaseStep.TypeTooltipDesc.ValueMapper",description="BaseStep.TypeLongDesc.ValueMapper",
		category=StepCategory.CATEGORY_TRANSFORM)
public class ValueMapperMeta extends BaseStepMeta implements StepMetaInterface
{
	public static final String STEP_ATTRIBUTE_FIELD_TO_USE = "field_to_use";
	public static final String STEP_ATTRIBUTE_TARGET_FIELD = "target_field";
	public static final String STEP_ATTRIBUTE_NON_MATCH_DEFAULT = "non_match_default";
	public static final String STEP_ATTRIBUTE_SOURCE_VALUE = "source_value";
	public static final String STEP_ATTRIBUTE_TARGET_VALUE = "target_value";
	...
	public void setInfo(Map<String, String[]> p, String id,
		...
		fieldToUse = BaseStepMeta.parameterToString(p.get(id + ".fieldToUse"));
		targetField = BaseStepMeta.parameterToString(p.get(id + ".targetField"));
		nonMatchDefault = BaseStepMeta.parameterToString(p.get(id + ".nonMatchDefault"));
		String[] sourceValue = p.get(id + "_fields.sourceValue");
		String[] targetValue = p.get(id + "_fields.targetValue");
		
		this.sourceValue = (sourceValue != null) ? sourceValue : (new String[0]);
		this.targetValue = (targetValue != null) ? targetValue : (new String[0]);
