...
public class StepCategory
{
	...
	public static final int CATEGORY_FLOW    		=  4;
	public static final int CATEGORY_SCRIPTING      =  5;
	public static final int CATEGORY_LOOKUP         =  6;
	public static final int CATEGORY_JOINS          =  7;
	public static final int CATEGORY_DATA_WAREHOUSE =  8;
	public static final int CATEGORY_VALIDATION		=  9;
	public static final int CATEGORY_STATISTICS		= 10;
	public static final int CATEGORY_JOB            = 11;
	public static final int CATEGORY_MAPPING        = 12;
	public static final int CATEGORY_INLINE         = 13;
	public static final int CATEGORY_EXPERIMENTAL   = 14;
	public static final int CATEGORY_DEPRECATED     = 15;
	public static final int CATEGORY_BULK		    = 16;
