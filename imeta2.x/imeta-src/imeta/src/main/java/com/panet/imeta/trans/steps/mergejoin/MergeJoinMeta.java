...
{
	public static final String STEP_ATTRIBUTE_STEP1 = "step1";
	public static final String STEP_ATTRIBUTE_STEP2 = "step2";
	public static final String STEP_ATTRIBUTE_JOIN_TYPE = "join_type";
	...
	public void setInfo(Map<String, String[]> p, String id,
		...
		stepName1 = BaseStepMeta.parameterToString(p.get(id + ".stepName1"));
		stepName2 = BaseStepMeta.parameterToString(p.get(id + ".stepName2"));
		joinType = BaseStepMeta.parameterToString(p.get(id + ".joinType"));
		this.keyFields1 = p.get(id + "_stepAGrid.value")==null?new String[0]:p.get(id + "_stepAGrid.value");
		this.keyFields2 = p.get(id + "_stepBGrid.value")==null?new String[0]:p.get(id + "_stepBGrid.value");
