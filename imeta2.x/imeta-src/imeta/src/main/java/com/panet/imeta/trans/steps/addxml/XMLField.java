...
public class XMLField implements Cloneable {
	...
	public XMLField(String fieldName, String elementName, int type,
			String format, int length, int precision, String currencySymbol,
			String decimalSymbol, String groupSymbol, String nullString,
			boolean attribute, String attributeName, String attributeParentName) {
	...
	/**
	 * @return true if the field should be encoded as attribute instead of a
	 *         child node.
	 */
	...
	/**
	 * @param attribute
	 *            set to true if the field should be encoded as attribute
