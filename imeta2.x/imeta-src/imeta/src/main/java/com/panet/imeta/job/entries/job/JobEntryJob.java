...
import com.panet.imeta.job.JobExecutionConfiguration;
...
public class JobEntryJob extends JobEntryBase implements Cloneable, JobEntryInterface
{
	...
	public void setInfo(Map<String, String[]> p, String id,
		...
		jobname = JobEntryBase.parameterToString(p.get(id + ".jobname"));
		...
		remoteSlaveServerName = JobEntryBase.parameterToString(p.get(id + ".remoteSlaveServerName"));
		waitingToFinish = JobEntryBase.parameterToBoolean(p.get(id + ".waitingToFinish"));
		followingAbortRemotely = JobEntryBase.parameterToBoolean(p.get(id + ".followingAbortRemotely"));
//		databaseMeta = JobEntryBase.findDatabase(databases, BaseStepMeta
//				.parameterToString(p.get(id + ".connection")));
//		rowLimit = JobEntryBase.parameterToInt(p.get(id + ".rowLimit"));
