...
public class ReservoirSamplingMeta extends BaseStepMeta implements
	...
	public static final String STEP_ATTRIBUTE_SAMPLE_SIZE = "sample_size";
	public static final String STEP_ATTRIBUTE_SEED = "seed";
	...
	public void setInfo(Map<String, String[]> p, String id,
		...
		m_sampleSize = BaseStepMeta
				.parameterToString(p.get(id + ".sampleSize"));
		m_randomSeed = BaseStepMeta
				.parameterToString(p.get(id + ".randomSeed"));
	}
}
