...
public class BlockingStepMeta  extends BaseStepMeta implements StepMetaInterface {
	...
	public static final String STEP_ATTRIBUTE_PASS_ALL_ROWS = "pass_all_rows";
	public static final String STEP_ATTRIBUTE_DIRECTOTY = "directory";
...
//    compressFiles =       rep.getStepAttributeBoolean(id_step, "compress");
    ...
    public void setInfo(Map<String, String[]> p, String id,
    	...
    	passAllRows = BaseStepMeta.parameterToBoolean(p.get(id + ".passAllRows"));
		...
		compressFiles = BaseStepMeta.parameterToBoolean(p.get(id + ".compressFiles"));
