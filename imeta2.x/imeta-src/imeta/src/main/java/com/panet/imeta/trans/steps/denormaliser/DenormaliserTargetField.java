...
public class DenormaliserTargetField
{
    ...
    public static final String[] typeAggrDescs = new String[] {
    	typeAggrDesc[0],typeAggrDesc[1],typeAggrDesc[2],typeAggrDesc[3],
    	typeAggrDesc[4],typeAggrDesc[5],typeAggrDesc[6]
