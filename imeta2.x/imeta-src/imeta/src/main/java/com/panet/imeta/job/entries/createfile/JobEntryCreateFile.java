...
public void setInfo(Map<String, String[]> p, String id,
	...
	this.addfilenameresult = BaseStepMeta.parameterToBoolean(p.get(id
			+ ".addfilenameresult"));
	this.failIfFileExists = BaseStepMeta.parameterToBoolean(p.get(id
			+ ".failIfFileExists"));
	this.filename= BaseStepMeta.parameterToString(p.get(id
			+ ".filename"));
}
