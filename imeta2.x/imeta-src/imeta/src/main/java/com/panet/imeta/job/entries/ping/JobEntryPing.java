...
public class JobEntryPing extends JobEntryBase implements Cloneable, JobEntryInterface
{
	...
	public void setInfo(Map<String, String[]> p, String id,
		...
		hostname = JobEntryBase.parameterToString(p.get(id + ".hostname"));
		nbrPackets = JobEntryBase.parameterToString(p.get(id + ".nbrPackets"));
		timeout = JobEntryBase.parameterToString(p.get(id + ".timeout"));
		pingtype = JobEntryBase.parameterToString(p.get(id + ".pingtype"));
		}
