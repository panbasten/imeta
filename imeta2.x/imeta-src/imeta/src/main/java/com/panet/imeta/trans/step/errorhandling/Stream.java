...
public class Stream implements StreamInterface {
	 ...
	 * @param description
	 */
	public Stream(StreamType streamType, StepMeta stepMeta, String description,
			StreamIcon streamIcon, Object subject) {
	...
	public String toString() {
		if (stepMeta == null) {
			...
			return "Stream type " + streamType + " for step '"
					+ stepMeta.getName() + "'" + Const.CR + description;
		}
	}
