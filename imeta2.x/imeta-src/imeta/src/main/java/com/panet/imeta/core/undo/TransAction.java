...
package com.panet.imeta.core.undo;
...
public class TransAction {
	...
	public static final String desc_action[] = new String[] { "",
			Messages.getString("TransAction.label.ChangeStep"),
			Messages.getString("TransAction.label.ChangeConnection"),
			Messages.getString("TransAction.label.ChangeHop"),
			Messages.getString("TransAction.label.ChangeNote"),
			Messages.getString("TransAction.label.NewStep"),
			Messages.getString("TransAction.label.NewConnection"),
			Messages.getString("TransAction.label.NewHop"),
			Messages.getString("TransAction.label.NewNote"),
			Messages.getString("TransAction.label.DeleteStep"),
			Messages.getString("TransAction.label.DeleteConnection"),
			Messages.getString("TransAction.label.DeleteHop"),
			Messages.getString("TransAction.label.DeleteNote"),
			Messages.getString("TransAction.label.PositionStep"),
			Messages.getString("TransAction.label.PositionNote"),
			Messages.getString("TransAction.label.ChangeJobEntry"),
			Messages.getString("TransAction.label.ChangeJobHop"),
			Messages.getString("TransAction.label.NewJobEntry"),
			Messages.getString("TransAction.label.NewJobHop"),
			Messages.getString("TransAction.label.DeleteJobEntry"),
			Messages.getString("TransAction.label.DeleteJobHop"),
			...
			Messages.getString("TransAction.label.ChangeTable"),
			Messages.getString("TransAction.label.ChangeRelationship"),
			Messages.getString("TransAction.label.NewTable"),
			Messages.getString("TransAction.label.NewRelationship"),
			Messages.getString("TransAction.label.DeleteTable"),
