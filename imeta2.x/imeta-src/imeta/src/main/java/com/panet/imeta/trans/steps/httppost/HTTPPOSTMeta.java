...
public class HTTPPOSTMeta extends BaseStepMeta implements StepMetaInterface
{
	...
	public void setInfo(Map<String, String[]> p, String id,
		...
		postafile = BaseStepMeta.parameterToBoolean(p.get(id + ".postafile"));
        ...
        requestEntity = BaseStepMeta.parameterToString(p.get(id + ".requestEntity"));
        fieldName = BaseStepMeta.parameterToString(p.get(id + ".fieldName"));
        
        String[] argumentField = p.get(id + "_bodyParameters.argumentField");
        String[] argumentParameter = p.get(id + "_bodyParameters.argumentParameter");
        this.argumentField = (argumentField != null) ? argumentField : (new String[0]);
        this.argumentParameter = (argumentParameter != null) ? argumentParameter : (new String[0]);
        
        String[] queryField = p.get(id + "_queryParameters.queryField");
        String[] queryParameter = p.get(id + "_queryParameters.queryParameter");
        this.queryField = (queryField != null) ? queryField : (new String[0]);
        this.queryParameter = (queryParameter != null) ? queryParameter : (new String[0]);
	}
}
