...
public class ColumnExistsMeta extends BaseStepMeta implements StepMetaInterface
{
	...
	public static final String STEP_ATTRIBUTE_SCHEAMNAME="scheamname";
	public static final String STEP_ATTRIBUTE_ISTABLENAMEINFIELD="istablenameinfield";
	public static final String STEP_ATTRIBUTE_TABLENAMEFIELD="tablenamefield";
	public static final String STEP_ATTRIBUTE_COLUMNNAMEFIELD="columnnamefield";
	public static final String STEP_ATTRIBUTE_RESULTFIELDNAME="resultfoeldname";
   ...
   @Override
	public void setInfo(Map<String, String[]> p, String id,
	   ...
	   istablenameInfield = BaseStepMeta.parameterToBoolean(p.get(id + ".istablenameInfield"));
	   tablenamefield = BaseStepMeta.parameterToString(p.get(id + ".tablenamefield"));
	   columnnamefield = BaseStepMeta.parameterToString(p.get(id + ".columnnamefield"));
	...
	try
	{
            ...
            schemaname = rep.getStepAttributeString(id_step, "SCHEAMNAME");
    ...
    public void saveRep(Repository rep, long id_transformation, long id_step) throws KettleException
    {
        try
        {
            ...
            rep.saveStepAttribute(id_transformation, id_step, "SCHEAMNAME", schemaname);
