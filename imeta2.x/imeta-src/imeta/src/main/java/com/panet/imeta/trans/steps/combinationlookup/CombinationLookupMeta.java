...
public class CombinationLookupMeta extends BaseStepMeta implements StepMetaInterface
{
	...
	public static final String STEP_ATTRIBUTE_CATCH_SIZE = "cache_size";
	...
	public static final String STEP_ATTRIBUTE_REPLACE = "replace";
	public static final String STEP_ATTRIBUTE_CRC = "crc";
...
//	techKeyCreation    = rep.getStepAttributeString (id_step, "creation_method"); //$NON-NLS-1$
	...
	public void setInfo(Map<String, String[]> p, String id,
		...
		databaseMeta  = DatabaseMeta.findDatabase(
				(List<DatabaseMeta>) databases, BaseStepMeta.parameterToLong(p.get(id + ".connection")));
		...
		replaceFields = BaseStepMeta.parameterToBoolean(p.get(id + ".replaceFields"));
		useHash = BaseStepMeta.parameterToBoolean(p.get(id + ".useHash"));
		hashField = BaseStepMeta.parameterToString(p.get(id + ".hashField"));
		technicalKeyField = BaseStepMeta.parameterToString(p.get(id + ".technicalKeyField"));
		useAutoinc = BaseStepMeta.parameterToBoolean(p.get(id + ".useAutoinc"));
		sequenceFrom = BaseStepMeta.parameterToString(p.get(id + ".sequenceFrom"));
		techKeyCreation = BaseStepMeta.parameterToString(p.get(id + ".techKeyCreation"));
		
		String[] keyField = p.get(id + "_keyWords.keyField");
