...
public class Messages {
	...
	public static String getString(String key) {
		try {
			return com.panet.imeta.i18n.BaseMessages.getString(packageName, key);
    ...
    public static String getString(String key, String param1) {
        try {
            return com.panet.imeta.i18n.BaseMessages.getString(packageName, key, param1);
        } catch (MissingResourceException e) {
    ...
    public static String getString(String key, String param1, String param2) {
        try {
            return com.panet.imeta.i18n.BaseMessages.getString(packageName, key, param1, param2);
        } catch (MissingResourceException e) {
    ...
    public static String getString(String key, String param1, String param2, String param3) {
        try {
            return com.panet.imeta.i18n.BaseMessages.getString(packageName, key, param1, param2, param3);
        } catch (MissingResourceException e) {
    ...
    public static String getString(String key, String param1, String param2, String param3, String param4) {
        try {
            return com.panet.imeta.i18n.BaseMessages.getString(packageName, key, param1, param2, param3,param4);
        } catch (MissingResourceException e) {
    ...
    public static String getString(String key, String param1, String param2, String param3,String param4,String param5) {
        try {
            return com.panet.imeta.i18n.BaseMessages.getString(packageName, key, param1, param2, param3, param4, param5);
        } catch (MissingResourceException e) {
    ...
    public static String getString(String key, String param1, String param2, String param3,String param4,String param5,String param6) {
        try {
            return com.panet.imeta.i18n.BaseMessages.getString(packageName, key, param1, param2, param3, param4, param5, param6);
        } catch (MissingResourceException e) {
