	...
	public void setInfo(Map<String, String[]> p, String id,
		...
		databaseMeta  = DatabaseMeta.findDatabase(
				(List<DatabaseMeta>) databases, BaseStepMeta.parameterToLong(p
						.get(id + ".connectionId")));
		executedEachInputRow = BaseStepMeta.parameterToBoolean(p.get(id + ".executedEachInputRow"));
		replaceVariables = BaseStepMeta.parameterToBoolean(p.get(id + ".replaceVariables"));
