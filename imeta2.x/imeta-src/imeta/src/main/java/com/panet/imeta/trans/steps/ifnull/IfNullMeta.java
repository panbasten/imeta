...
{
	public static final String STEP_ATTRIBUTE_REPLACEALLBYVALUE = "replaceAllByValue";
	public static final String STEP_ATTRIBUTE_REPLACEALLMASK = "replaceAllMask";
	public static final String STEP_ATTRIBUTE_SELECTFIELDS = "selectFields";
	public static final String STEP_ATTRIBUTE_SELECTVALUESTYPE = "selectValuesType";
...
//	selectValuesType = rep.getStepAttributeBoolean(id_step, "selectValuesType");
   ...
   public String getXML()
	...
	public void setInfo(Map<String, String[]> p, String id,
		...
		replaceAllByValue = BaseStepMeta.parameterToString(p.get(id + ".replaceAllByValue"));
		replaceAllMask = BaseStepMeta.parameterToString(p.get(id + ".replaceAllMask"));
		selectFields = BaseStepMeta.parameterToBoolean(p.get(id + ".selectFields"));
		selectValuesType = BaseStepMeta.parameterToBoolean(p.get(id + ".selectValuesType"));

		String[] typeName = p.get(id + "_types.typeName");
		String[] typereplaceValue = p.get(id + "_types.typereplaceValue");
		String[] typereplaceMask = p.get(id + "_types.typereplaceMask");
		String[] fieldName = p.get(id + "_fields.fieldName");
		String[] replaceValue = p.get(id + "_fields.replaceValue");
		String[] replaceMask = p.get(id + "_fields.replaceMask");

		this.typeName = (typeName != null) ? typeName : (new String[0]);
		this.typereplaceValue = (typereplaceValue != null) ? typereplaceValue : (new String[0]);
		this.typereplaceMask = (typereplaceMask != null) ? typereplaceMask : (new String[0]);
		this.fieldName = (fieldName != null) ? fieldName : (new String[0]);
		this.replaceValue = (replaceValue != null) ? replaceValue : (new String[0]);
		this.replaceMask = (replaceMask != null) ? replaceMask : (new String[0]);
	}
