...
{
	public static final String STEP_ATTRIBUTE_HEAD_NAME = "head_name";
	public static final String STEP_ATTRIBUTE_TAIL_NAME = "tail_name";
...
//	tailStepName =  rep.getStepAttributeString (id_step, "tail_name");  //$NON-NLS-1$
    ...
    public void setInfo(Map<String, String[]> p, String id,
    	...
    	headStepName = BaseStepMeta.parameterToString(p.get(id + ".headStepName"));
    	tailStepName = BaseStepMeta.parameterToString(p.get(id + ".tailStepName"));
