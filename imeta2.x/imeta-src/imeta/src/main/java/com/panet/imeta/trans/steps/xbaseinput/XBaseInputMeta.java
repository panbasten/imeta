...
{
	public static final String STEP_ATTRIBUTE_FILE_DBF = "file_dbf";
	public static final String STEP_ATTRIBUTE_LIMIT = "limit";
	public static final String STEP_ATTRIBUTE_ADD_ROWNR = "add_rownr";
	public static final String STEP_ATTRIBUTE_FIELD_ROWNR = "field_rownr";
	...
	public static final String STEP_ATTRIBUTE_CHARSET_NAME = "charset_name";
	...
	public void setInfo(Map<String, String[]> p, String id,
		...
		dbfFileName = BaseStepMeta.parameterToString(p.get(id + ".dbfFileName"));
		rowLimit = BaseStepMeta.parameterToInt(p.get(id + ".rowLimit"));
		rowNrAdded = BaseStepMeta.parameterToBoolean(p.get(id + ".rowNrAdded"));   
		rowNrField = BaseStepMeta.parameterToString(p.get(id + ".rowNrField"));   
        ...
        charactersetName = BaseStepMeta.parameterToString(p.get(id + ".charactersetName")); 
        acceptingFilenames = BaseStepMeta.parameterToBoolean(p.get(id + ".acceptingFilenames"));
        acceptingField = BaseStepMeta.parameterToString(p.get(id + ".acceptingField"));    
        acceptingStepName = BaseStepMeta.parameterToString(p.get(id + ".acceptingStepName"));
    }
	...
	public void readRep(Repository rep, long id_step, List<DatabaseMeta> databases, Map<String, Counter> counters)
		...
		try
		{
			dbfFileName              =      rep.getStepAttributeString (id_step, STEP_ATTRIBUTE_FILE_DBF); //$NON-NLS-1$
			rowLimit              = (int)rep.getStepAttributeInteger(id_step, STEP_ATTRIBUTE_LIMIT); //$NON-NLS-1$
			rowNrAdded             =      rep.getStepAttributeBoolean(id_step, STEP_ATTRIBUTE_ADD_ROWNR); //$NON-NLS-1$
			rowNrField           =      rep.getStepAttributeString (id_step, STEP_ATTRIBUTE_FIELD_ROWNR); //$NON-NLS-1$
            ...
            charactersetName = rep.getStepAttributeString(id_step, STEP_ATTRIBUTE_CHARSET_NAME);

            acceptingFilenames = rep.getStepAttributeBoolean(id_step, STEP_ATTRIBUTE_ACCEPT_FILENAMES);
            acceptingField     = rep.getStepAttributeString (id_step, STEP_ATTRIBUTE_ACCEPT_FIELD);
            acceptingStepName  = rep.getStepAttributeString (id_step, STEP_ATTRIBUTE_ACCEPT_STEPNAME);
