...
{
	public static final String STEP_ATTRIBUTE_FLAG_FIELD = "flag_field";
	public static final String STEP_ATTRIBUTE_COMPARE = "compare";
	public static final String STEP_ATTRIBUTE_REFERENCE = "reference";
    ...
    public void setInfo(Map<String, String[]> p, String id,
    	...
    	flagField = BaseStepMeta.parameterToString(p.get(id + ".flagField"));
    	referenceStepName = BaseStepMeta.parameterToString(p.get(id + ".referenceStepName"));
    	compareStepName = BaseStepMeta.parameterToString(p.get(id + ".compareStepName"));
    	this.keyFields = p.get(id + "_matchkeywords.fieldName")==null?new String[0]:p.get(id + "_matchkeywords.fieldName");
		this.valueFields = p.get(id + "_dateField.valueFields")==null?new String[0]:p.get(id + "_dateField.valueFields");
	}
