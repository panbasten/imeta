...
public class CalculatorMetaFunction implements Cloneable
{
    ...
    public static final String[] fieldTypeDesc = new String[] { "",
    	calcLongDesc[1],calcLongDesc[2],calcLongDesc[3],
    	calcLongDesc[4],calcLongDesc[5],calcLongDesc[6],
    	calcLongDesc[7],calcLongDesc[8],calcLongDesc[9],
    	calcLongDesc[10],calcLongDesc[11],calcLongDesc[12],
    	calcLongDesc[13],calcLongDesc[14],calcLongDesc[15],
    	calcLongDesc[16],calcLongDesc[17],calcLongDesc[18],
    	calcLongDesc[19],calcLongDesc[20],calcLongDesc[21],
    	calcLongDesc[22],calcLongDesc[23],calcLongDesc[24],
    	calcLongDesc[25],calcLongDesc[26],calcLongDesc[27],
    	calcLongDesc[28],calcLongDesc[29],calcLongDesc[30],
    	calcLongDesc[31],calcLongDesc[32],calcLongDesc[33],
    	calcLongDesc[34],calcLongDesc[35],calcLongDesc[36],
    	calcLongDesc[37],calcLongDesc[38],calcLongDesc[39],
    	calcLongDesc[40],calcLongDesc[41],calcLongDesc[42],
    	calcLongDesc[43],calcLongDesc[44],calcLongDesc[45],
    	calcLongDesc[46],calcLongDesc[47],calcLongDesc[48],
    	calcLongDesc[49],calcLongDesc[50],calcLongDesc[51],
    	calcLongDesc[52],calcLongDesc[53],calcLongDesc[54],
    };
