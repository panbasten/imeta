...
import com.panet.imeta.core.gui.GUISizeInterface;
...
public class NotePadMeta implements Cloneable, XMLInterface, GUIPositionInterface, GUISizeInterface
{
	...
	public NotePadMeta(LogWriterInterface log, Repository rep, long id_note)
	...
	private void readRep(LogWriterInterface log, Repository rep, long id_note) throws KettleException
	{
		try
		{
			setID(id_note);
