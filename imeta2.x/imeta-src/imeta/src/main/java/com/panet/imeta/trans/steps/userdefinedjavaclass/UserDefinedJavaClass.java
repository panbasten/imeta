...
public class UserDefinedJavaClass extends BaseStep implements StepInterface {
	...
	public RowSet findInputRowSetImpl(String from, int fromcopy, String to,
			int tocopy) {
	...
	public RowSet findOutputRowSetImpl(String from, int fromcopy, String to,
			int tocopy) {
	...
	public Map getPartitionTargetsImpl() {
	...
	public void putError(RowMetaInterface rowMeta, Object[] row, long nrErrors,
			...
			throws KettleStepException {
		if (child == null) {
			putErrorImpl(rowMeta, row, nrErrors, errorDescriptions, fieldNames,
					errorCodes);
		} else {
			child.putError(rowMeta, row, nrErrors, errorDescriptions,
					fieldNames, errorCodes);
		}
	}

	public void putErrorImpl(RowMetaInterface rowMeta, Object[] row,
			long nrErrors, String errorDescriptions, String fieldNames,
			String errorCodes) throws KettleStepException {
		super.putError(rowMeta, row, nrErrors, errorDescriptions, fieldNames,
				errorCodes);
	}
	...
	public void putRowImpl(RowMetaInterface row, Object[] data)
			throws KettleStepException {
	...
	public void putRowToImpl(RowMetaInterface rowMeta, Object[] row,
			RowSet rowSet) throws KettleStepException {
