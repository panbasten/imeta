...
public class GetFileNamesMeta extends BaseStepMeta implements StepMetaInterface
{
	...
	public static final String STEP_ATTRIBUTE_FILTERFILETYPE = "filterfiletype";
	public static final String STEP_ATTRIBUTE_FILENAME_FIELD = "filename_Field";
	public static final String STEP_ATTRIBUTE_WILDCARD_FIELD = "wildcard_Field";
...
//	public static final String STEP_ATTRIBUTE_FILE_NAME = "file_name";
	...
	public void setInfo(Map<String, String[]> p, String id,
		...
		String ftf = BaseStepMeta.parameterToString(p.get(id + ".fileTypeFilter"));
		if("all_files".equals(ftf)){
			fileTypeFilter = FileInputList.FileTypeFilter.FILES_AND_FOLDERS;
		}else if("only_files".equals(ftf)){
			fileTypeFilter = FileInputList.FileTypeFilter.ONLY_FILES;
		}else if("only_folders".equals(ftf)){
			fileTypeFilter = FileInputList.FileTypeFilter.ONLY_FOLDERS;
		}
		...
		filefield = BaseStepMeta.parameterToBoolean(p.get(id + ".filenameDefined"));
		rowNumberField = BaseStepMeta.parameterToString(p.get(id + ".rowNumberField"));
		dynamicFilenameField = BaseStepMeta.parameterToString(p.get(id + ".dynamicFilenameField"));
		dynamicWildcardField = BaseStepMeta.parameterToString(p.get(id + ".dynamicWildcardField"));
		...
		this.fileRequired = (fileRequired != null) ? fileRequired : (new String[0]);
    }
	...
	public void readRep(Repository rep, long id_step, List<DatabaseMeta> databases, Map<String, Counter> counters) throws KettleException
	{
		try
		{
			...
			fileTypeFilter=FileInputList.FileTypeFilter.getByName(rep.getStepAttributeString(id_step, STEP_ATTRIBUTE_FILTERFILETYPE));
			
			dynamicFilenameField  = rep.getStepAttributeString(id_step, STEP_ATTRIBUTE_FILENAME_FIELD);
			dynamicWildcardField  = rep.getStepAttributeString(id_step, STEP_ATTRIBUTE_WILDCARD_FIELD);
			
			includeRowNumber  = rep.getStepAttributeBoolean(id_step, STEP_ATTRIBUTE_ROWNUM);
			isaddresult  = rep.getStepAttributeBoolean(id_step, rep.getStepAttributeString(id_step, STEP_ATTRIBUTE_ISADDRESULT));
			...
			for (int i = 0; i < nrfiles; i++)
			{
				...
				fileRequired[i] = rep.getStepAttributeString(id_step, i, STEP_ATTRIBUTE_FILE_REQUIRED);
