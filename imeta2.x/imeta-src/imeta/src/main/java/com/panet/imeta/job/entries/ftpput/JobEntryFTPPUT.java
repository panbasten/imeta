...
public class JobEntryFTPPUT extends JobEntryBase implements Cloneable, JobEntryInterface
{
	...
	public void setInfo(Map<String, String[]> p, String id,
		...
		remoteDirectory = JobEntryBase.parameterToString(p.get(id + ".remoteDirectory"));
		...
		onlyPuttingNewFiles = JobEntryBase.parameterToBoolean(p.get(id + ".onlyPuttingNewFiles"));	
