...
public class JobEntryEval extends JobEntryBase implements Cloneable, JobEntryInterface {
	...
	public static final String ENTRY_ATTRIBUTE_SCRIPT = "script";
  ...
  public void loadRep(Repository rep, long id_jobentry, List<DatabaseMeta> databases, List<SlaveServer> slaveServers) throws KettleException {
    try {
      ...
      script = rep.getJobEntryAttributeString(id_jobentry, ENTRY_ATTRIBUTE_SCRIPT); //$NON-NLS-1$
  ...
  public void saveRep(Repository rep, long id_job) throws KettleException {
    try {
      ...
      rep.saveJobEntryAttribute(id_job, getID(), ENTRY_ATTRIBUTE_SCRIPT, script); //$NON-NLS-1$
    } catch (KettleDatabaseException dbe) {
