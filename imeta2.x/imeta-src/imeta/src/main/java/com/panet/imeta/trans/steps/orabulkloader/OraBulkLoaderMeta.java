 ...
 * @author Sven Boden
 */
public class OraBulkLoaderMeta extends BaseStepMeta implements
		StepMetaInterface {
	...
	private void readData(Node stepnode,
		...
		try {
			...
			dbNameOverride = XMLHandler
					.getTagValue(stepnode, "dbname_override"); //$NON-NLS-1$#

			characterSetName = XMLHandler
					.getTagValue(stepnode, "character_set"); //$NON-NLS-1$
			...
			for (int i = 0; i < nrvalues; i++) {
				...
				if (locDateMask == null) {
					...
					if (OraBulkLoaderMeta.DATE_MASK_DATE.equals(locDateMask)
							|| OraBulkLoaderMeta.DATE_MASK_DATETIME
									.equals(locDateMask)) {
			...
			throw new KettleXMLException(
					Messages
							.getString("OraBulkLoaderMeta.Exception.UnableToReadStepInfoFromXML"), e); //$NON-NLS-1$
		}
	}
	...
	public String getXML() {
		...
		retval
				.append("    ").append(XMLHandler.addTagValue("bind_size", bindSize)); //$NON-NLS-1$ //$NON-NLS-2$
		retval
				.append("    ").append(XMLHandler.addTagValue("read_size", readSize)); //$NON-NLS-1$ //$NON-NLS-2$
		retval
				.append("    ").append(XMLHandler.addTagValue("errors", maxErrors)); //$NON-NLS-1$ //$NON-NLS-2$
		retval
		...
		retval
				.append("    ").append(XMLHandler.addTagValue("load_method", loadMethod)); //$NON-NLS-1$ //$NON-NLS-2$
		retval
				.append("    ").append(XMLHandler.addTagValue("load_action", loadAction)); //$NON-NLS-1$ //$NON-NLS-2$
		retval.append("    ").append(XMLHandler.addTagValue("sqlldr", sqlldr)); //$NON-NLS-1$ //$NON-NLS-2$
		retval
				.append("    ").append(XMLHandler.addTagValue("control_file", controlFile)); //$NON-NLS-1$ //$NON-NLS-2$
		retval
				.append("    ").append(XMLHandler.addTagValue("data_file", dataFile)); //$NON-NLS-1$ //$NON-NLS-2$
		retval
				.append("    ").append(XMLHandler.addTagValue("log_file", logFile)); //$NON-NLS-1$ //$NON-NLS-2$
		retval
				.append("    ").append(XMLHandler.addTagValue("bad_file", badFile)); //$NON-NLS-1$ //$NON-NLS-2$
		retval
				.append("    ").append(XMLHandler.addTagValue("discard_file", discardFile)); //$NON-NLS-1$ //$NON-NLS-2$

		retval
				.append("    ").append(XMLHandler.addTagValue("direct_path", directPath)); //$NON-NLS-1$ //$NON-NLS-2$
		retval
				.append("    ").append(XMLHandler.addTagValue("erase_files", eraseFiles)); //$NON-NLS-1$ //$NON-NLS-2$
		retval
				.append("    ").append(XMLHandler.addTagValue("encoding", encoding)); //$NON-NLS-1$ //$NON-NLS-2$
		retval
				.append("    ").append(XMLHandler.addTagValue("dbname_override", dbNameOverride)); //$NON-NLS-1$ //$NON-NLS-2$

		retval
				.append("    ").append(XMLHandler.addTagValue("character_set", characterSetName)); //$NON-NLS-1$ //$NON-NLS-2$
		retval
				.append("    ").append(XMLHandler.addTagValue("fail_on_warning", failOnWarning)); //$NON-NLS-1$ //$NON-NLS-2$
		retval
				.append("    ").append(XMLHandler.addTagValue("fail_on_error", failOnError)); //$NON-NLS-1$ //$NON-NLS-2$
		retval
				.append("    ").append(XMLHandler.addTagValue("alt_rec_term", altRecordTerm)); //$NON-NLS-1$ //$NON-NLS-2$
	...
	public void readRep(Repository rep, long id_step,
		...
		try {
			...
			dbNameOverride = rep.getStepAttributeString(id_step,
					"dbname_override");//$NON-NLS-1$

			characterSetName = rep.getStepAttributeString(id_step,
					"character_set"); //$NON-NLS-1$
			failOnWarning = rep.getStepAttributeBoolean(id_step,
					"fail_on_warning"); //$NON-NLS-1$
			...
			throw new KettleException(
					Messages
							.getString("OraBulkLoaderMeta.Exception.UnexpectedErrorReadingStepInfoFromRepository"), e); //$NON-NLS-1$
		}
	}
	...
	public void saveRep(Repository rep, long id_transformation, long id_step)
		...
		try {
			...
			rep.saveStepAttribute(id_transformation, id_step,
					"bind_size", bindSize); //$NON-NLS-1$
			rep.saveStepAttribute(id_transformation, id_step,
					"read_size", readSize); //$NON-NLS-1$
			rep.saveStepAttribute(id_transformation, id_step,
					"errors", maxErrors); //$NON-NLS-1$
			rep.saveStepAttribute(id_transformation, id_step,
			...
			rep.saveStepAttribute(id_transformation, id_step,
					"direct_path", directPath); //$NON-NLS-1$
			rep.saveStepAttribute(id_transformation, id_step,
					"erase_files", eraseFiles); //$NON-NLS-1$
			rep.saveStepAttribute(id_transformation, id_step,
					"encoding", encoding); //$NON-NLS-1$
			rep.saveStepAttribute(id_transformation, id_step,
					"dbname_override", dbNameOverride);//$NON-NLS-1$

			rep.saveStepAttribute(id_transformation, id_step,
					"character_set", characterSetName); //$NON-NLS-1$
			rep.saveStepAttribute(id_transformation, id_step,
					"fail_on_warning", failOnWarning); //$NON-NLS-1$
			rep.saveStepAttribute(id_transformation, id_step,
					"fail_on_error", failOnError); //$NON-NLS-1$			
			rep.saveStepAttribute(id_transformation, id_step,
					"alt_rec_term", altRecordTerm); //$NON-NLS-1$
			...
			throw new KettleException(
					Messages
							.getString("OraBulkLoaderMeta.Exception.UnableToSaveStepInfoToRepository") + id_step, e); //$NON-NLS-1$
		}
	}
	...
	public void check(List<CheckResultInterface> remarks, TransMeta transMeta,
		...
		if (databaseMeta != null) {
			...
			try {
				...
				if (!Const.isEmpty(tableName)) {
					cr = new CheckResult(
							...
							Messages
									.getString("OraBulkLoaderMeta.CheckResult.TableNameOK"), stepMeta); //$NON-NLS-1$
					remarks.add(cr);
					...
					String schemaTable = databaseMeta
							.getQuotedSchemaTableCombination(transMeta
					...
					if (r != null) {
						cr = new CheckResult(
								CheckResultInterface.TYPE_RESULT_OK,
								Messages
										.getString("OraBulkLoaderMeta.CheckResult.TableExists"), stepMeta); //$NON-NLS-1$
						remarks.add(cr);
							...
							if (v == null) {
								if (first) {
									...
									error_message += Messages
											.getString("OraBulkLoaderMeta.CheckResult.MissingFieldsToLoadInTargetTable") + Const.CR; //$NON-NLS-1$
								}
								error_found = true;
						...
						if (error_found) {
							...
							cr = new CheckResult(
									CheckResultInterface.TYPE_RESULT_OK,
									Messages
											.getString("OraBulkLoaderMeta.CheckResult.AllFieldsFoundInTargetTable"), stepMeta); //$NON-NLS-1$
						}
						remarks.add(cr);
					} else {
						error_message = Messages
								.getString("OraBulkLoaderMeta.CheckResult.CouldNotReadTableInfo"); //$NON-NLS-1$
						cr = new CheckResult(
								CheckResultInterface.TYPE_RESULT_ERROR,
								error_message, stepMeta);
						remarks.add(cr);
				...
				if (prev != null && prev.size() > 0) {
					cr = new CheckResult(
							...
							Messages
									.getString(
											"OraBulkLoaderMeta.CheckResult.StepReceivingDatas", prev.size() + ""), stepMeta); //$NON-NLS-1$ //$NON-NLS-2$
					remarks.add(cr);
					...
					for (int i = 0; i < fieldStream.length; i++) {
						ValueMetaInterface v = prev
								.searchValueMeta(fieldStream[i]);
						if (v == null) {
							if (first) {
								first = false;
								error_message += Messages
										.getString("OraBulkLoaderMeta.CheckResult.MissingFieldsInInput") + Const.CR; //$NON-NLS-1$
							}
							error_found = true;
					...
					if (error_found) {
						...
						cr = new CheckResult(
								CheckResultInterface.TYPE_RESULT_OK,
								Messages
										.getString("OraBulkLoaderMeta.CheckResult.AllFieldsFoundInInput"), stepMeta); //$NON-NLS-1$
					}
					remarks.add(cr);
				} else {
					error_message = Messages
							.getString("OraBulkLoaderMeta.CheckResult.MissingFieldsInInput3") + Const.CR; //$NON-NLS-1$
					cr = new CheckResult(
							CheckResultInterface.TYPE_RESULT_ERROR,
							error_message, stepMeta);
					remarks.add(cr);
				...
				error_message = Messages
						.getString("OraBulkLoaderMeta.CheckResult.DatabaseErrorOccurred") + e.getMessage(); //$NON-NLS-1$
			...
			error_message = Messages
					.getString("OraBulkLoaderMeta.CheckResult.InvalidConnection"); //$NON-NLS-1$
			cr = new CheckResult(CheckResultInterface.TYPE_RESULT_ERROR,
					error_message, stepMeta);
			remarks.add(cr);
		}
		...
		if (input.length > 0) {
			cr = new CheckResult(
					CheckResultInterface.TYPE_RESULT_OK,
					Messages
							.getString("OraBulkLoaderMeta.CheckResult.StepReceivingInfoFromOtherSteps"), stepMeta); //$NON-NLS-1$
			remarks.add(cr);
		} else {
			cr = new CheckResult(
					CheckResultInterface.TYPE_RESULT_ERROR,
					Messages
							.getString("OraBulkLoaderMeta.CheckResult.NoInputError"), stepMeta); //$NON-NLS-1$
			remarks.add(cr);
		}
	}
			...
			if (prev != null && prev.size() > 0) {
				...
				if (!Const.isEmpty(tableName)) {
					...
					try {
						...
						retval
								.setError(Messages
										.getString("OraBulkLoaderMeta.GetSQL.ErrorOccurred") + e.getMessage()); //$NON-NLS-1$
					}
				} else {
					retval
							.setError(Messages
									.getString("OraBulkLoaderMeta.GetSQL.NoTableDefinedOnConnection")); //$NON-NLS-1$
				}
			} else {
				retval
						.setError(Messages
								.getString("OraBulkLoaderMeta.GetSQL.NotReceivingAnyFields")); //$NON-NLS-1$
			}
		} else {
			retval.setError(Messages
					.getString("OraBulkLoaderMeta.GetSQL.NoConnectionDefined")); //$NON-NLS-1$
		}
	...
	public StepInterface getStep(StepMeta stepMeta,
			...
			Trans trans) {
		return new OraBulkLoader(stepMeta, stepDataInterface, cnr, transMeta,
				trans);
	}
	...
	public RowMetaInterface getRequiredFields() throws KettleException {
		if (databaseMeta != null) {
			...
			try {
				...
				if (!Const.isEmpty(tableName)) {
					...
					if (db.checkTableExists(schemaTable)) {
						...
						throw new KettleException(
								Messages
										.getString("OraBulkLoaderMeta.Exception.TableNotFound"));
					}
				} else {
					throw new KettleException(
							Messages
									.getString("OraBulkLoaderMeta.Exception.TableNotSpecified"));
				}
			} catch (Exception e) {
				throw new KettleException(
						Messages
								.getString("OraBulkLoaderMeta.Exception.ErrorGettingFields"),
						e);
			} finally {
				db.disconnect();
			}
			...
			throw new KettleException(
					Messages
							.getString("OraBulkLoaderMeta.Exception.ConnectionNotDefined"));
		}
	...
	public void setInfo(Map<String, String[]> p, String id,
		...
		this.databaseMeta.setID(Long.parseLong(BaseStepMeta.parameterToString(p
				.get(id + ".dbconnect"))));
		this.schemaName = BaseStepMeta.parameterToString(p.get(id
				+ ".schemaName"));
		this.tableName = BaseStepMeta.parameterToString(p
				.get(id + ".tableName"));
		this.sqlldr = BaseStepMeta.parameterToString(p.get(id + ".sqlldr"));
		this.loadMethod = BaseStepMeta.parameterToString(p.get(id
				+ ".loadMethod"));
		this.loadAction = BaseStepMeta.parameterToString(p.get(id
				+ ".loadAction"));
		this.bindSize = BaseStepMeta.parameterToInt(p.get(id + ".bindSize"));
		this.readSize = BaseStepMeta.parameterToInt(p.get(id + ".readSize"));
		this.dbNameOverride = BaseStepMeta.parameterToString(p.get(id
				+ ".dbNameOverride"));
		this.controlFile = BaseStepMeta.parameterToString(p.get(id
				+ ".controlFile"));
		this.dataFile = BaseStepMeta.parameterToString(p.get(id + ".dataFile"));
		this.logFile = BaseStepMeta.parameterToString(p.get(id + ".logFile"));
		this.badFile = BaseStepMeta.parameterToString(p.get(id + ".badFile"));
		this.discardFile = BaseStepMeta.parameterToString(p.get(id
				+ ".discardFile"));
		this.encoding = BaseStepMeta.parameterToString(p.get(id + ".encoding"));
		this.characterSetName = BaseStepMeta.parameterToString(p.get(id
				+ ".characterSetName"));
		this.altRecordTerm = BaseStepMeta.parameterToString(p.get(id
				+ ".altRecordTerm"));
		this.directPath = BaseStepMeta.parameterToBoolean(p.get(id
				+ ".directPath"));
		this.eraseFiles = BaseStepMeta.parameterToBoolean(p.get(id
				+ ".eraseFiles"));
		this.failOnWarning = BaseStepMeta.parameterToBoolean(p.get(id
				+ ".failOnWarning"));
		this.failOnError = BaseStepMeta.parameterToBoolean(p.get(id
				+ ".failOnError"));
		this.fieldTable = p.get(id + "_fields.fieldTable") == null ? new String[0]
				: p.get(id + "_fields.fieldTable");
		this.fieldStream = p.get(id + "_fields.fieldStream") == null ? new String[0]
				: p.get(id + "_fields.fieldStream");
		this.dateMask = p.get(id + "_fields.dateMask") == null ? new String[0]
				: (p.get(id + "_fields.dateMask"));
