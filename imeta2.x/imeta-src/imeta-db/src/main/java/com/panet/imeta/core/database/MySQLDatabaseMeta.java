...
public class MySQLDatabaseMeta extends BaseDatabaseMeta implements DatabaseInterface
{
	...
	/**
	 * @see com.panet.imeta.core.database.DatabaseInterface#getNotFoundTK(boolean)
	 */
	...
	/* (non-Javadoc)
	 * @see com.panet.imeta.core.database.DatabaseInterface#getReservedWords()
	 */
	...
	/* (non-Javadoc)
	 * @see com.panet.imeta.core.database.DatabaseInterface#getStartQuote()
	 */
	 ...
	 * @see com.panet.imeta.core.database.DatabaseInterface#getEndQuote()
	 */
