...
public class RowsFromResultDialog extends BaseStepDialog implements
		StepDialogInterface {
	/**
	 * 列式表单
	 */
	...
	public RowsFromResultDialog(StepMeta stepMeta, TransMeta transMeta) {
	...
	public JSONObject open() throws ImetaException {
		try {
			...
			RowsFromResultMeta step = (RowsFromResultMeta)super.getStep();
			// 得到form
			...
			this.fields.setHasAdd(true, true,
					"jQuery.imeta.steps.rowsfromresult.btn.fieldsAdd");
			this.fields.setHasDelete(true, true,
			        "jQuery.imeta.parameter.fieldsDelete");
			this.fields.setSingle(true);

			String[] field = step.getName();
