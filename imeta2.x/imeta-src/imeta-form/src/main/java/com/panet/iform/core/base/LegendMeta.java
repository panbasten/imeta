...
*@since 2009/06/22
*/ 
public class LegendMeta extends SimpleFormMeta {
	 ...
	 *              是否单独显示
	 */
	public LegendMeta(SimpleFormDataMeta dataMeta, boolean single) {
		super(dataMeta, SimpleFormMeta.LEGEND_TAG, single);
	}
