...
/**
 * Contains a buffer of rows. Getting rows from the buffer or putting rows in
 * the buffer is synchronized to allow concurrent use of multiple Threads.
 * 
 * @author Matt
 * @since 04-04-2003
 * 
 */
public class BlockingRowSet extends BaseRowSet {
	...
	public BlockingRowSet(int maxSize) {
		...
		timeoutGet = Const.toInt(System
				.getProperty(Props.STRING_ROWSET_GET_TIMEOUT),
				Const.TIMEOUT_GET_MILLIS);
		timeoutPut = Const.toInt(System
				.getProperty(Props.STRING_ROWSET_PUT_TIMEOUT),
	 ...
	 */
	public boolean putRowWait(RowMetaInterface rowMeta, Object[] rowData,
