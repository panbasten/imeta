...
public class OverlayPropertyHandler implements PropertyHandler {
	protected static final String propFile = "imate.properties";
	...
	protected boolean loadAltProps() {
		// check the -D switch... something like -Dcom.panet.imeta.laf.alt="somefile.properties"
		String altFile = Const.getEnvironmentVariable("com.panet.imeta.laf.alt",null);
		if (altFile!=null) {
