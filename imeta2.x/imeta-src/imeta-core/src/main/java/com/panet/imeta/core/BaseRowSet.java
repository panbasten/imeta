 ...
 * 
 */
abstract class BaseRowSet extends RowSet {
	...
	/**
	 * Compares using the target steps and copy, not the source. That way,
	 * re-partitioning is always done in the same way.
	 * 
	 */
	public int compareTo(RowSet rowSet) {
		String target = remoteSlaveServerName + "." + destinationStepName + "."
				+ destinationStepCopy.intValue();
		String comp = rowSet.getRemoteSlaveServerName() + "."
				+ rowSet.getDestinationStepName() + "."
	 ...
	 * (non-Javadoc)
	 * 
	 * @seeorg.pentaho.di.core.RowSetInterface#putRow(org.pentaho.di.core.row.
	 * RowMetaInterface, java.lang.Object[])
	 */
	 ...
	 * 
	 * @see
	 * org.pentaho.di.core.RowSetInterface#putRowWait(org.pentaho.di.core.row
	 * .RowMetaInterface, java.lang.Object[], long,
	 * java.util.concurrent.TimeUnit)
	 */
	public abstract boolean putRowWait(RowMetaInterface rowMeta,
			Object[] rowData, long time, TimeUnit tu);
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.pentaho.di.core.RowSetInterface#getRowWait(long,
	 * java.util.concurrent.TimeUnit)
	 */
	 ...
	 * 
	 * @see
	 * org.pentaho.di.core.RowSetInterface#setThreadNameFromToCopy(java.lang
	 * .String, int, java.lang.String, int)
	 */
	public void setThreadNameFromToCopy(String from, int from_copy, String to,
			int to_copy) {
	 ...
	 * 
	 * @see
	 * org.pentaho.di.core.RowSetInterface#setRowMeta(org.pentaho.di.core.row
	 * .RowMetaInterface)
	 */
	 ...
	 * 
	 * @see
	 * org.pentaho.di.core.RowSetInterface#setRemoteSlaveServerName(java.lang
	 * .String)
	 */
