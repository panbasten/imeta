 ...
 * jQuery UI Droppable
 * 
 * Copyright (c) 2008 Paul Bakaus Dual licensed under the MIT (MIT-LICENSE.txt)
...
(function($) {
	...
	$.widget("ui.droppable", {
		init : function() {
			...
			o = $.extend(o, {
						accept : o.accept && o.accept.constructor == Function
								? o.accept
								: function(d) {
									return $(d).is(accept);
								}
		...
		over : function(e) {
			...
			if (this.options.accept.call(this.element,
					(draggable.currentItem || draggable.element))) {
				$.ui.plugin.call(this, 'over', [e, this.ui(draggable)]);
				this.element
						.triggerHandler("dropover", [e, this.ui(draggable)]);
				if (this.options.over)
					this.options.over(e, this.ui(draggable));
			}
		...
		out : function(e) {
			...
			if (this.options.accept.call(this.element,
				...
				if (this.options.out)
					this.options.out(e, this.ui(draggable));
			}
		...
		drop : function(e, custom) {
			...
			this.element.find(".ui-droppable").not(".ui-draggable-dragging")
					.each(function() {
			...
			if (this.options.accept.call(this.element,
				...
				if (this.options.drop)
					this.options.drop(e, this.ui(draggable));
		...
		activate : function(e) {
			...
			if (draggable) {
				this.element.triggerHandler("dropactivate", [e,
								this.ui(draggable)]);
				if (this.options.activate)
					this.options.activate(e, this.ui(draggable));
			}
		...
		deactivate : function(e) {
			...
			if (draggable) {
				this.element.triggerHandler("dropdeactivate", [e,
								this.ui(draggable)]);
				if (this.options.deactivate)
					this.options.deactivate(e, this.ui(draggable));
			}
		}
	});
		...
		prepareOffsets : function(t, e) {
			...
			for (var i = 0; i < m.length; i++) {
				...
				if (type == "dragstart" || type == "sortactivate")
					m[i].activate.call(m[i], e); // Activate the droppable if
				// used directly from
				// draggables
			}
